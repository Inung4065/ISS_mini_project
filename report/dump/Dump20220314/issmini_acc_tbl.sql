...
LOCK TABLES `acc_tbl` WRITE;
/*!40000 ALTER TABLE `acc_tbl` DISABLE KEYS */;
INSERT INTO `acc_tbl` VALUES ('admin','admin','admin');
/*!40000 ALTER TABLE `acc_tbl` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-03-14 19:01:58
